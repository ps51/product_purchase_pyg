...
app.controller('cartController',function($scope,cartService,$location){
    ...
    $scope.commitAddress = function () {
        ...
        $scope.SpikeAddress = {};
        $scope.SpikeAddress.receiverAddress = address.provinceId + " "
            + address.cityId + " " + address.townId + " " + address.address;
        $scope.SpikeAddress.receiverMobile = address.mobile;
        $scope.SpikeAddress.receiver = address.contact;
        $scope.SpikeAddress.id = orderId;
        console.log($scope.SpikeAddress)
        cartService.saveSpikeAddress( $scope.SpikeAddress).success(function (response) {
            if(response.success){
                location.href="paysuccess.html";
            }else{
                location.href="payfail.html";
