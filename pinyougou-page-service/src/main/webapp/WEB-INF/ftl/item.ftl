...
<#--读取图片列表(是一个字符串JSON的)  eval  将JSON字符串转为对象-->
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<#if (imageList?size > 0) >
								<span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}"   style="width:400px;height:400px"/></span>
							</#if>
						</div>
						<!--下方的缩略图-->
							...
							<#list specificationItems as spec>
								<dl>
									...
									<#list spec.attributeValue as value>
										<dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${value}') ? 'selected' : ''}}" ng-click="selectSpecification('${spec.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<button  target="_blank" class="sui-btn  btn-danger addshopcar" ng-click="addTocart()">加入购物车</button>
									</li>
								</ul>
							</div>
						</div>
